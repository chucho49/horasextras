function capturaDeDatos(){
     ...
     var Ho_ex_noc_dominical=document.getElementById("hendominicales").value;
        ...
        var valor_total=ho_diurna_total+ho_ex_diurna_total2+ho_noc_total+ho_ex_noc_total2+ho_di_dominical_total2+ho_ex_di_dominical_total2+ho_noc_dominical_total2+Ho_ex_noc_dominical_total2;
        ...
        document.getElementById("valor_total_text").innerText=` $ `+ parseInt(valor_total);
